...
Shader "Unlit/s_CelShading" {
    Properties {
        ...
        _CycleColorImpact ("CycleColorImpact", Range(0, 1)) = 1
    }
    SubShader {
        Tags {
            "RenderType"="Opaque"
        ...
        Pass {
            ...
            uniform float _CycleColorImpact;
            struct VertexInput {
