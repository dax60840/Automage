    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i, float facing : VFACE) : COLOR {
                ...
                float node_3943 = ((_DissolveMask_var.r+1.0)-(2.0*(1.0 - i.vertexColor.a)));
                clip(node_3943 - 0.5);
