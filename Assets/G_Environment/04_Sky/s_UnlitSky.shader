    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                float2 node_870 = (i.uv0*float2(_UScale,_VScale));
                float2 node_6839 = node_870.rg;
