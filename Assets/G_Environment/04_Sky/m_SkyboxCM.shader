...
////// Lighting:
////// Emissive:
                float3 emissive = (lerp((_DayExponant*texCUBE(_CubemapDay,viewReflectDirection).rgb),(texCUBE(_CubemapNight,viewReflectDirection).rgb*_NightExponant),_CycleDayNight)*_CycleColor.rgb);
